...
#ifndef INTARNA_PREDICTORMFEENS4D_H_
#define INTARNA_PREDICTORMFEENS4D_H_
 ...
 *
 */
class PredictorMfeEns4d: public PredictorMfeEns {
...
public:
	 ...
	 *         on this->destruction.
	 */
	PredictorMfeEns4d( const InteractionEnergy & energy
					, OutputHandler & output
					, PredictionTracker * predTracker );

	virtual ~PredictorMfeEns4d();
...
#endif /* INTARNA_PREDICTORMFEENS4D_H_ */
