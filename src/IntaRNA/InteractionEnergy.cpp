...
getE_contributions( const Interaction & interaction ) const
{
	...
	contr.dangleLeft = Z_2_E(E_2_Z(getE_danglingLeft( i1, i2 ))*getPr_danglingLeft(i1,j1,i2,j2));
	contr.dangleRight = Z_2_E(E_2_Z(getE_danglingRight( j1, j2 ))*getPr_danglingRight(i1,j1,i2,j2));
